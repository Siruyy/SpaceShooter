...
def main():
    ...
    level = 0
    lives = 5
    main_font = pygame.font.SysFont("Kenvector Future Thin Regular", 20)
    lost_font = pygame.font.SysFont("Kenvector Future Thin Regular", 65)
    ...
    while run:
        ...
        if len(enemies) == 0:
            ...
            for i in range(wave_length):
                enemy = Enemy(random.randrange(50, WIDTH-100), random.randrange(-1500, -70), random.choice(["red", "green"]))
...
def main_menu():
    title_font = pygame.font.SysFont("Kenvector Future Thin Regular", 40)
    run = True
    while run:
        WIN.blit(BG, (0,0))
